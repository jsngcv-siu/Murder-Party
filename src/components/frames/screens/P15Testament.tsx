    ...
    <div className="h-full flex flex-col bg-background overflow-y-auto">
      ...
      <header className="relative px-5 pt-7 pb-5 overflow-hidden">
        <div
          ...
          style={{ background: "radial-gradient(ellipse at 50% 100%, oklch(0.80 0.17 78 / 0.25), transparent 70%)" }}
        />
        <div className="relative flex items-center gap-3.5">
          ...
          <div className="min-w-0">
            <div className="text-[10px] uppercase tracking-[0.25em] text-muted-foreground" style={{ fontFamily: "var(--font-display)" }}>Testament</div>
            <h2 className="text-xl font-bold leading-tight" style={{ fontFamily: "var(--font-display)", color: "oklch(0.88 0.13 84)" }}>Tes dernières paroles</h2>
          </div>
        </div>
        <p className="relative mt-3.5 text-sm leading-relaxed text-muted-foreground">
          Rédige dès maintenant le message qui sera révélé au cimetière en cas de mort.
          Modifiable à tout moment tant que le cœur bat.
        </p>
      </header>

    ...
    pages: [
      {
        ...
        notes: [
          ...
          {
            tag: "Arme discrète",
            body: "Le couteau est un objet de ton inventaire : personne ne sait que tu le portes tant que tu ne frappes pas.",
          },
          {
            tag: "Frappe à froid",
    ...
    pages: [
      {
        ...
        notes: [
          ...
          },
          {
            ...
            body: "Tueur, Croque-mitaine, ou tout objet d'origine méchante — même volé ou joué par un Civil.",
          },
          {

...
export const TONE_CLS: Record<Tone, string> = {
  ...
  emerald:
    "bg-emerald-500/12 text-emerald-200 border-emerald-400/40 shadow-[0_0_12px_-4px_oklch(0.70_0.18_145/0.5)]",
  rose: "bg-rose-500/12 text-rose-200 border-rose-400/40 shadow-[0_0_12px_-4px_oklch(0.65_0.22_22/0.5)]",
  redDark:
    "bg-red-900/30 text-red-200 border-red-700/55 shadow-[0_0_12px_-4px_oklch(0.50_0.22_22/0.5)]",
  amber:
    "bg-amber-500/12 text-amber-200 border-amber-400/40 shadow-[0_0_12px_-4px_oklch(0.78_0.16_60/0.5)]",
  yellow:
    "bg-yellow-500/12 text-yellow-200 border-yellow-400/40 shadow-[0_0_12px_-4px_oklch(0.86_0.18_85/0.55)]",
  orange:
    "bg-orange-500/12 text-orange-200 border-orange-400/40 shadow-[0_0_12px_-4px_oklch(0.72_0.18_45/0.5)]",
  purple:
    "bg-purple-500/15 text-purple-200 border-purple-400/45 shadow-[0_0_12px_-4px_oklch(0.60_0.20_300/0.5)]",
  pink: "bg-pink-500/12 text-pink-200 border-pink-400/40 shadow-[0_0_12px_-4px_oklch(0.68_0.22_350/0.5)]",
  fuchsia:
    "bg-fuchsia-500/12 text-fuchsia-200 border-fuchsia-400/40 shadow-[0_0_12px_-4px_oklch(0.65_0.24_320/0.5)]",
  stone:
    "bg-stone-500/15 text-stone-200 border-stone-400/40 shadow-[0_0_12px_-4px_oklch(0.60_0.04_55/0.4)]",
  deadGreen:
    "bg-emerald-700/22 text-emerald-200 border-emerald-700/50 shadow-[0_0_12px_-4px_oklch(0.50_0.16_145/0.55)]",
};

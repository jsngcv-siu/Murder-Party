...
- **Pastille** ⏳ _En cours_ (effet différé) / ✓ _Fait_ (confirmation) — le texte résultat
...
**Boussole** _(mode verdict : texte coloré, pas de badge)_

- Action : « Tu as orienté ta boussole vers X. »
- Résultat : « Même camp » (vert) / « Camps opposés » (rouge)
- Cible falsifiée : « Le joueur a été falsifié »

**Chasseur de vampire** _(mode verdict)_
...
**Apothicaire — Fiole de clairvoyance** _(objet)_
...
_(Le couteau d'inventaire, s'il est utilisé : action « Tu as utilisé Couteau sur X » +
pastille ⏳ En cours ; message « X : coup de couteau — à l'Annonce. »)_
...
| **Avocat**                     | Tu as défendu X.                          | _(panneau prison)_                                                                          |
...
3. Sinon → **ligne d'action + pastille** : ⏳ _En cours_ si l'effet parle de « l'Annonce »
   (ou est marqué en attente), sinon ✓ _Fait_.
